...
<?php for ($i = 0; $i < 50; $i++) { ?>
        ...
        echo "selected=selected";
            ...
            <div class="leftCol" >
                <label for="txtLocationCode"><?php echo __("District") ?><span class="required">*</span></label>
            </div>
            <div class="centerCol" id="cmbDistrict">
                <select name="cmbDistrict" class="formSelect" style="width: 150px;" tabindex="4"  >
                    <option value=""><?php echo __("--Select--") ?></option>
<?php foreach ($DistrictList as $District) {
    if ($Employee->hie_code_3 == $District->id) { ?>
                            <option value="<?php echo $District->id; ?>" <?php if ($District->id == $Employee->hie_code_3) {
                        echo "selected=selected";
                    } if ($District->id == $CmbYear) {
                        echo "selected=selected";
                    } ?> ><?php
                        echo $District->title;
                        ?></option>
